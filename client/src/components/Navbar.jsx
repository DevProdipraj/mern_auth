...
const Navbar = () => {
  ...
  return (
    <div className="container py-5 flex justify-between items-center">
      <div onClick={() => navigate("/")} className="text-2xl font-bold bg-gradient-to-r from-green-400 via-blue-500 to-purple-600 px-3 py-1 bg-clip-text text-transparent cursor-pointer">MERN AUTH</div>
